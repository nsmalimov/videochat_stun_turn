...
!function (a, b) {
    ...
    a.introLoader = function (b, c) {
        ...
        e.init = function () {
            ...
            switch (i) {
                case"simpleLoader":
                    e.spinner = new Spinner(g).spin(), h(b, k, g);
                    break;
                case"doubleLoader":
                    j(b, k);
                    break;
                case"lettersLoader":
                    e.spinner = new Spinner(g).spin(), l(b, k, g);
                    break;
                case"counterLoader":
        ...
        var f = function (b, c) {
            ...
            c.onBefore(), p(b, c, "simpleLoader");
            var d = "";
            d += '<div id="introLoaderSpinner" class="introLoaderInner">', d += "</div>", a(b).html(d), a(b).show();
            var f = document.getElementById("introLoaderSpinner");
            e.spinner.spin(f), c.stop === !0 && a(window).on("load", function () {
                i()
            })
        }, i = function () {
            var a = e.settings.animation.options;
            ...
            c.onBefore(), p(b, c, "lettersLoader");
            var d = r(c.loaderText, "lettersLoaderItem"), f = "";
            f += '<div id="introLoaderSpinner" class="introLoaderInner"></div>', f += '<div id="lettersLoaderAnimation" class="lettersLoaderRow">', f += d, f += "</div>", a(b).html(f), a(b).show();
            ...
            setTimeout(function () {
                ...
                d.each(function (b) {
                    ...
                    c.delayBefore = c.delayAfter, q(c, !1)
                })
            }, c.delayBefore)
        }, n = function (b, c) {
            c.onBefore(), p(b, c, "counterLoader");
            var d = "";
